        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{route('person.edit', $model)}}"><button type="button" class="btn btn-primary">Редактировать</button></a>
                    <a href="{{route('person.index')}}" class="btn btn-primary">К списку</a>
